...
export class SurveyProvider {
    ...
    getActiveSurveys(): Observable<any> {
        return this.http.get('https://surveyjs.io/api/MySurveys/getActive?ownerId=' + this.ownerId + '&accessKey=' + this.accessKey).pipe(
    ...
    getArchiveSurveys(): Observable<any> {
        return this.http.get('https://surveyjs.io/api/MySurveys/getArchive?ownerId=' + this.ownerId + '&accessKey=' + this.accessKey).pipe(
            timeoutWith(5000, Observable.throw(new Error('Failed to get surveys.')))
        );
    }
    ...
    getSurveyResults(idSurvey: any): Observable<any> {
        return this.http.get<ItemsResponse>('https://surveyjs.io/api/MySurveys/getSurveyResults/' + idSurvey + '?accessKey=' + this.accessKey).pipe(
    ...
    deleteSurvey(idSurvey: any): Observable<any> {
        return this.http.get('https://surveyjs.io/api/MySurveys/delete/' + idSurvey + '?accessKey=' + this.accessKey).pipe(
    ...
    changeSurveyName(idSurvey, newName): Observable<any> {
        return this.http.get('https://surveyjs.io/api/MySurveys/changeName/' + idSurvey + '?accessKey=' + this.accessKey + '&name=' + encodeURI(newName)).pipe(
    ...
    restoreSurvey(idSurvey): Observable<any> {
        return this.http.get('https://surveyjs.io/api/MySurveys/restore/' + idSurvey + '?accessKey=' + this.accessKey).pipe(
    ...
    archiveSurvey(idSurvey) : Observable<any> {
        return this.http.get('https://surveyjs.io/api/MySurveys/archive/' + idSurvey + '?accessKey=' + this.accessKey).pipe(
    ...
    createSurvey(name): Observable<any> {
        return this.http.get('https://surveyjs.io/api/MySurveys/create?ownerId=' + this.ownerId + '&accessKey=' + this.accessKey + '&name=' + encodeURI(name)).pipe(
    ...
    deleteSurveyResult(postId, instanceId): Observable<any> {
        return this.http.get('https://surveyjs.io/api/MySurveys/deleteResult?accessKey=' + this.accessKey + '&postId=' + postId + '&instanceId=' + instanceId).pipe(
    ...
    makeSurveyResultsPublic(idSurvey, makeResultPublic): Observable<any> {
        return this.http.get('https://surveyjs.io/api/MySurveys/makeResultPublic/' + idSurvey + '?accessKey=' + this.accessKey + '&makeResultPublic=' + makeResultPublic).pipe(
